function Jump_over1(AL,AR,AT,AD,_zL,_zR,_zT,_zD,b,_z,_x,_y,AL3,AR3,AT3,AD3,AL4,AR4,AT4,AD4,cdL,cdR,cdT,cdD,n_i){
if 
(
	...
	|| (Obj_enemy.position.z >= AL.position.z+AL.position.z_height-32 && Obj_enemy.position.z < 32))
	//&& (n_i == noone || (AR3 != noone && AR3.position.z < b.position.z+b.position.z_height && n_i.position.z == Obj_enemy.position.z_ground+32) || (n_i.position.z != Obj_enemy.position.z_ground+32) )
	)
	||(_z >= AL.position.z+AL.position.z_height && //_z <= Obj_enemy.position.z_ground+Obj_enemy.jump_dis &&
	...
	//&& (AL.position.z+AL.position.z_height <= Obj_enemy.position.z+Obj_enemy.jump_dis)
	//&& b.position.z+b.position.z_height > Obj_enemy.position.z_ground+32+Obj_enemy.jump_dis
	))
	)
||
	...
	|| (Obj_enemy.position.z >= AR.position.z+AR.position.z_height-32 && Obj_enemy.position.z < 32))
	//&& (n_i == noone || (AL3 != noone && AL3.position.z < b.position.z+b.position.z_height && n_i.position.z == Obj_enemy.position.z_ground+32) || (n_i.position.z != Obj_enemy.position.z_ground+32) )
	)
	||(_z >= AR.position.z+AR.position.z_height && //_z <= Obj_enemy.position.z_ground+Obj_enemy.jump_dis &&
	...
	//&& (AR.position.z+AR.position.z_height <= Obj_enemy.position.z+Obj_enemy.jump_dis)
	//&& b.position.z+b.position.z_height > Obj_enemy.position.z_ground+32+Obj_enemy.jump_dis
	))
	)
||
	...
	|| (Obj_enemy.position.z >= AT.position.z+AT.position.z_height-32 && Obj_enemy.position.z < 32))
	//&& (n_i == noone || (AD3 != noone && AD3.position.z < b.position.z+b.position.z_height && n_i.position.z == Obj_enemy.position.z_ground+32) || (n_i.position.z != Obj_enemy.position.z_ground+32) )
	)
	||(_z >= AT.position.z+AT.position.z_height && //_z <= Obj_enemy.position.z_ground+Obj_enemy.jump_dis &&
	...
	//&& (AT.position.z+AT.position.z_height <= Obj_enemy.position.z+Obj_enemy.jump_dis)
	//&& b.position.z+b.position.z_height > Obj_enemy.position.z_ground+32+Obj_enemy.jump_dis
	))
	)
||
	...
	|| (Obj_enemy.position.z >= AD.position.z+AD.position.z_height-32 && Obj_enemy.position.z < 32))
	//&& (n_i == noone || (AT3 != noone && AT3.position.z < b.position.z+b.position.z_height && n_i.position.z == Obj_enemy.position.z_ground+32) || (n_i.position.z != Obj_enemy.position.z_ground+32) )
	)
	||(_z >= AD.position.z+AD.position.z_height && //_z <= Obj_enemy.position.z_ground+Obj_enemy.jump_dis &&
	...
	&& (AT3 != noone && AT3.position.z+AT3.position.z > b.position.z)
	//&& (AD.position.z+AD.position.z_height <= Obj_enemy.position.z+Obj_enemy.jump_dis)
	//&& b.position.z+b.position.z_height > Obj_enemy.position.z_ground+32+Obj_enemy.jump_dis
	))
	)
)
